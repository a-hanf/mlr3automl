get_portfolio_design = function(task_type, param_set) {
  initial_design = data.table::data.table(
        subsample.frac = c(1, 0.1, 0.33, 1),
        numeric.branch.selection = "imputation.imputemean",
        factor.branch.selection = "imputation.imputeoor",
        encoding.branch.selection = "stability.encode",
        dimensionality.branch.selection = "dimensionality.nop",
        branch.selection = paste0(task_type, c(".featureless", ".ranger", ".ranger", ".ranger")),
        dimensionality.pca.rank. = NA_integer_,
        classif.ranger.mtry = c(NA, 0.5, 0.5, 0.5),
        ...
        classif.xgboost.nrounds = NA_integer_,
        ...
        regr.ranger.mtry = c(NA, 0.5, 0.5, 0.5),
        ...
        regr.xgboost.nrounds = NA_integer_,
